...
const data = {
  ...
  techs : [
    ...
    {name:'Gas Extraction', tech:'harvestGasGiant', colour:[50,47,73], requires:['missileFrigateTech'], hex:new Hex(3,-4), cost:6, sprite:[['gasGiant',0,0,1],['harvestGasGiant',0,0,1]] },
    ...
    {name:'Harvest Protostar', tech:'harvestProtostar', colour:[50,47,73], requires:['harvestHydrogen'], hex:new Hex(-3,-1), cost:6, sprite:[['protostar',0,-15,0.75],['harvestProtostar',0,-11,0.75]] },
    {name:'Radiation Shield', tech:'armouredDestroyerTech', colour:[50,47,73], requires:['asteroidIceMining'], hex:new Hex(-1,-3), cost:6, sprite:[['armouredDestroyer',0,0,1]] },
    ...
    {name:'Missile Frigate', tech:'missileFrigateTech', colour:[50,47,73], hex:new Hex(5,-6), cost:4, sprite:[['missileFrigate',0,0,1]] },
    ...
    {name:'Fast Frigate', tech:'fastFrigateTech', colour:[50,47,73], hex:new Hex(1,5), cost:4, sprite:[['fastFrigate',0,0,1]] },
    {name:'Asteroid Movement', tech:'asteroidMove', colour:[50,47,73], requires:['fastFrigateTech'], hex:new Hex(-1,6), cost:4, sprite:[['asteroids',0,-10,0.75]] },
    {name:'Hydroponics', tech:'hydroponicsTech', colour:[51,49,50], requires:['navBeacon'], hex:new Hex(-3,6), cost:99999, },
    {name:'Scouting', tech:'scoutShipTech', colour:[50,47,73], hex:new Hex(-5,6), cost:4, sprite:[['scoutShip',0,0,1]] },
    ...
    {name:'Advanced Sensors', tech:'nebulaVision', colour:[50,47,73], hex:new Hex(-6,1), cost:4, sprite:[['nebula',0,-10,0.75]] },
