...
function raw2(ctx){
  ...
  ctx.bezierCurveTo(99.7, 30.8, 97.2, 55.1, 80.6, 68.6);
  ctx.bezierCurveTo(64.1, 82.1, 39.8, 79.6, 26.3, 63.0);
  ...
  ctx.addColorStop(0.28, "rgb(26, 60, 87)");
  ctx.addColorStop(0.58, "rgb(35, 50, 85)");
  ctx.addColorStop(0.90, "rgb(44, 41, 83)");
  ctx.fillStyle()
  ctx.fill();
  ...
  ctx.bezierCurveTo(87.1, 34.7, 74.8, 42.7, 59.9, 49.4);
  ...
  ctx.bezierCurveTo(4.6, 45.9, -1.8, 56.1, 1.3, 63.1);
  ...
  ctx.addColorStop(0.00, "rgb(26, 60, 87)");
  ctx.addColorStop(0.14, "rgb(35, 50, 85)");
  ctx.addColorStop(0.41, "rgb(44, 41, 83)");
  ctx.addColorStop(0.89, "rgb(35, 50, 85)");
  ctx.addColorStop(1.00, "rgb(26, 60, 87)");
  ctx.fillStyle();
  ctx.fill();
  ctx.strokeStyle( "rgb(18, 14, 34)");
  ctx.stroke();
  ctx.restore();
  ctx.restore();
  return ctx.data;
